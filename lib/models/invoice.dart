...
class Invoice {
  ...
  factory Invoice.fromMap(Map<String, dynamic> map) => Invoice(
    ...
    electricityHigherLastMonth: (map['electricityHigherLastMonth'] as num).toDouble(),
    electricityHigherNewMonth: (map['electricityHigherNewMonth'] as num).toDouble(),
    electricityLowerLastMonth: (map['electricityLowerLastMonth'] as num).toDouble(),
    electricityLowerNewMonth: (map['electricityLowerNewMonth'] as num).toDouble(),
    gasLastMonth: (map['gasLastMonth'] as num).toDouble(),
    gasNewMonth: (map['gasNewMonth'] as num).toDouble(),
    waterLastMonth: (map['waterLastMonth'] as num).toDouble(),
    waterNewMonth: (map['waterNewMonth'] as num).toDouble(),
